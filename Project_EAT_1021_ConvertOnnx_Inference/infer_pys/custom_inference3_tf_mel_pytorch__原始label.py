...
PT_NAME="../save_pts/dymn20_as_1022_LEN_2__custom22_epoch_29_acc_1000.pt"
TARGET_SEC=2
...
def custom_infer(audio_path):
    ...
    mel = AugmentMelSTFTTF(win_length=window_size,hopsize=hop_size,n_mels=n_mels,sr=32000)
...
if __name__ == '__main__':
    ...
    dirs=['fold0/','fold1/','fold2/',
          ...
          'fold15/','fold16/','fold17/','fold18/','fold19/']
