...
from customDataset import get_custom22_valid_set, get_custom22_train_set
...
def train(args):
    ...
    for epoch in range(args.n_epochs):
        ...
        print("模型保存: ",os.path.join(wandb.run.dir, name) )
...
if __name__ == '__main__':
    ...
    parser.add_argument('--gain_augment', type=int, default=4)
